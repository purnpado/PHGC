...
func (dm *DBManager) InitConfigDB() error {
	...
	// 기본 커트라인 실데이터 시드 (울산 관내 마이스터고 3교 2024-2026 및 후기일반고)
	_, _ = db.Exec(`
		...
		-- 울산에너지고등학교 (230점 만점)
		(2024, '울산에너지고등학교', '', '일반', 'total_score', 180.20, 225.00, 201.50),
		(2024, '울산에너지고등학교', '', '특별', 'total_score', 175.50, 215.00, 194.00),
		(2024, '울산에너지고등학교', '공통', '일반전형', 'total_score', 180.20, 225.00, 201.50),
		(2024, '울산에너지고등학교', '공통', '특별전형', 'total_score', 175.50, 215.00, 194.00),
		(2025, '울산에너지고등학교', '', '일반', 'total_score', 182.10, 226.50, 203.20),
		(2025, '울산에너지고등학교', '', '특별', 'total_score', 177.00, 218.00, 196.50),
		(2025, '울산에너지고등학교', '공통', '일반전형', 'total_score', 182.10, 226.50, 203.20),
		(2025, '울산에너지고등학교', '공통', '특별전형', 'total_score', 177.00, 218.00, 196.50),
		(2026, '울산에너지고등학교', '', '일반', 'total_score', 184.50, 228.00, 205.30),
		(2026, '울산에너지고등학교', '', '특별', 'total_score', 179.80, 220.50, 198.70),
		(2026, '울산에너지고등학교', '공통', '일반전형', 'total_score', 184.50, 228.00, 205.30),
		(2026, '울산에너지고등학교', '공통', '특별전형', 'total_score', 179.80, 220.50, 198.70),

		-- 현대공업고등학교 (200점 만점)
		(2024, '현대공업고등학교', '', '일반', 'total_score', 152.00, 195.00, 172.50),
		(2024, '현대공업고등학교', '', '특별', 'total_score', 148.50, 188.00, 168.00),
		(2024, '현대공업고등학교', '공통', '일반전형', 'total_score', 152.00, 195.00, 172.50),
		(2024, '현대공업고등학교', '공통', '특별전형', 'total_score', 148.50, 188.00, 168.00),
		(2025, '현대공업고등학교', '', '일반', 'total_score', 155.20, 196.80, 174.00),
		(2025, '현대공업고등학교', '', '특별', 'total_score', 150.00, 190.00, 170.20),
		(2025, '현대공업고등학교', '공통', '일반전형', 'total_score', 155.20, 196.80, 174.00),
		(2025, '현대공업고등학교', '공통', '특별전형', 'total_score', 150.00, 190.00, 170.20),
		(2026, '현대공업고등학교', '', '일반', 'total_score', 158.00, 198.50, 176.40),
		(2026, '현대공업고등학교', '', '특별', 'total_score', 152.50, 192.00, 171.80),
		(2026, '현대공업고등학교', '공통', '일반전형', 'total_score', 158.00, 198.50, 176.40),
		(2026, '현대공업고등학교', '공통', '특별전형', 'total_score', 152.50, 192.00, 171.80),

		-- 후기 일반계고 (석차백분율 기준)
		(2024, '울산 후기 일반계고', '공통', '일반계고', 'percentile', 85.0, 85.0, 85.0),
		(2025, '울산 후기 일반계고', '공통', '일반계고', 'percentile', 85.0, 85.0, 85.0),
